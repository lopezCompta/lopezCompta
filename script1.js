...
function createExercice(){
    ...
    exercice = "Enregistrer une facture " + typeFacture + " " + typeOperation + 
...
function validate() {
    ...
    if (typeOperation == "de Marchandises" 
    ...
    else if (typeOperation == "de Marchandises" 
    ...
    else if (typeOperation == "de Matières Premières" &&
    ...
    else if (typeOperation == "de Produits Finis" 
