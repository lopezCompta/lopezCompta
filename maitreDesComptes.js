...
function pass(){
    if(eventActual == "init"){
        ...
        if(monsterActual == "Banquier Sauvage"){
            ...
            setText("narration","L'Oracle des Ressources Humaines vous inflige 355 points de dégats");
...
function winFight(){
    setText("narration","");
        ...
        setText("attackText","Vous attaquez le Banquier sauvage et infligez " + degat +" points de dégats !");
